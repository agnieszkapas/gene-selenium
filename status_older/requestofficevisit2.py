...
class Requestofficevisit2(unittest.TestCase):
    def setUp(self):
    ...
    def test_requestofficevisit2(self):
        driver = self.driver
        ...
        driver.find_element_by_id("zip").send_keys("10001")
        driver.find_element_by_id("zip").clear()
        driver.find_element_by_id("zip").send_keys("10001")
        ...
        driver.find_element_by_id("appointmentBy").clear()
        driver.find_element_by_id("appointmentBy").send_keys("12")
        driver.find_element_by_id("appointmentBy").clear()
        driver.find_element_by_id("appointmentBy").send_keys("12")
