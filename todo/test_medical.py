...
class UntitledTestCase(unittest.TestCase):
    ...
    def test_untitled_test_case(self):
        driver = self.driver
        driver.get("https://www.gene.com/medical-professionals/medinfo")
        #driver.find_element_by_xpath("//span/ul").click()
        driver.find_element_by_xpath("(//input[@type='search'])[2]").clear()
        driver.find_element_by_xpath("(//input[@type='search'])[2]").send_keys("tarceva")
        #driver.find_element_by_name("search_string").click()
        driver.find_element_by_name("search_string").clear()
        driver.find_element_by_name("search_string").send_keys("treatment science")
